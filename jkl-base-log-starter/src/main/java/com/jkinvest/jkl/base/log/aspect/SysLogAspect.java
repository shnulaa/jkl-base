package com.jkinvest.jkl.base.log.aspect;
...
import com.jkinvest.jkl.base.log.event.SysLogEvent;
import com.jkinvest.jkl.base.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.jkinvest.jkl.base.base.controller.*.*(..)) || @annotation(com.jkinvest.jkl.base.log.annotation.SysLog)")
